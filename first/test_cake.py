...
class TestFindFactors(unittest.TestCase):
    ...
    def test_find_factors_of_1(self):
        self.assertEquals(findFactors(1),[1,1])
    

    def test_find_factors_of_10(self):
        self.assertEquals(findFactors(10),[1,2,5,10])
    
    
    def test_find_factors_of_prime_7(self):
        self.assertEquals(findFactors(7),[1,7])

    #1, 2, 4, 5, 8, 10, 20, 25, 40, 50, 100, 200.
    def test_find_factors_of_200(self):
        self.assertEquals(findFactors(200),[1,2,4,5,8,10,20,25,40,50,100,200])
...
class TestSliceCheck(unittest.TestCase):
    ...
    def test_single_letter(self):
        self.assertEquals(sliceCheck(['a'],1),True)
    

    def test_no_repeats_fail(self):
        x = list('abc')
        self.assertEquals(sliceCheck(x,1),False)
        self.assertEquals(sliceCheck(x,2),False)
        self.assertEquals(sliceCheck(x,3),True)
    ...
    def test_one_repeat_pass(self):
        ...
        self.assertEquals(sliceCheck(x,3),True)
        self.assertEquals(sliceCheck(x,2),False)
        self.assertEquals(sliceCheck(x,4),False)


    def test_repeats_with_extra_letters_fail(self):
        x = list('abcvvvabc')
        self.assertEquals(sliceCheck(x,3),False)
